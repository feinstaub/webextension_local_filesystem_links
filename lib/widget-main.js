...
const js_jqueryui_path = "js/jquery-ui-1.11.4.min.js";
...
// currentPageInfo currently contains the URL of the setting which caused the current page to be ignored
exports.updateCurrentPageInfo = function(currentPageInfo) {
    ////console.log("updateCurrentPageInfo: " + currentPageInfo);
    toolbarPanel.postMessage({
        type: "updateCurrentPageInfo", 
...
var actionRescanPage = function() {
    //// console.log("actionRescanPage");
    main.rescanCurrentTab();
};

var attachScriptsToOptionsTab = function(tab) {
...
var closeOrBlankTab = function(tab) {
    if (tabs.length > 1) {
