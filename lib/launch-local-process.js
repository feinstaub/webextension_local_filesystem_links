...
//
var getEnvironmentVariable = function (variableName) {
...
//
var getNsIFileFromPath = function (localPath) {
...
////  // create an nsILocalFile for the executable  
////  var process = Cc["@mozilla.org/process/util;1"].createInstance(Cc.interfaces.nsIProcess);
////  process.init(nsFile);
////  // Run the process.  
...
var pathExists = function (localPath) {
...
exports.revealPathInFileManager = function(localPath) {
  ...
  console.log("revealPathInFileManager: " + localPath);
