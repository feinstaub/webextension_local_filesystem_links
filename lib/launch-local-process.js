...
exports.showPathInWindowsExplorer = function(localPath) {
  ...
  let explorerCallCmdFile = getILocalFileFromPath(cmdPath);
  ...
  if (localFile.isFile()) {
    ...
    explorerArgs = "/root"; // "/e,/root" does not work because of the ,
  } else {
  ...
  runProcess(explorerCallCmdFile, cmdArgs, false);
}
