...
////  // TODO: make "" around path with a comma (,) (works in the console but not when calling it with runProcess :( )
////  // TODO: try to tamper with runProcess itself
////
////  //let cmdArgs = [ "/c", "explorer " + explorerArgs + "," + localPath ];
////  let cmdArgs = [ explorerArgs + "," , localPath];
////
////  //// console.debug("exePath: " + explorerExePath);
////  //// console.debug("cmdArgs: " + cmdArgs);
////  runProcess(explorerExeFile, cmdArgs, false);
}
